...
export const CONNECTOR_CATEGORIES: ConnectorCategoryMeta[] = [
  { id: 'ai', label: 'AI & Models', description: 'LLM providers powering Chat, Agents and evals.' },
  {
    id: 'gateway',
    label: 'Gateways',
    description: 'Aggregator gateways exposing models from many vendors — add any OpenAI-compatible one.',
  },
...
/** Decide the coarse service type for an AI provider (all are LLM today). */
function aiType(): string {
  return 'LLM';
}
...
const AI_CONNECTORS: KnownConnector[] = [
  ...
  },
  {
    ...
    isProvider: true,
    placeholder: '…',
    doc: 'https://api.together.ai/settings/api-keys',
    icon: '⬡',
  },
  {
    id: 'local',
    ...
    connectorType: 'Local',
    isProvider: true,
    placeholder: 'optional base URL only',
    icon: '⛁',
  },
];
...
const BUSINESS_CONNECTORS: KnownConnector[] = [
  ...
  },
  {
    ...
    connectorType: 'Docs',
    placeholder: 'secret_…',
    doc: 'https://www.notion.so/my-integrations',
    icon: '📄',
  },
  {
    id: 'linear',
    label: 'Linear',
    category: 'business',
    connectorType: 'Project mgmt',
    placeholder: 'lin_api_…',
    doc: 'https://linear.app/settings/api',
    icon: '▤',
  },
  {
    id: 'asana',
    ...
    connectorType: 'Project mgmt',
    placeholder: '…',
    doc: 'https://app.asana.com/0/my-apps',
    icon: '▧',
  },
  {
    id: 'trello',
  ...
  },
  {
    ...
    placeholder: 'pat…',
    doc: 'https://airtable.com/create/tokens',
    icon: '▣',
  },
  {
    id: 'hubspot',
    ...
    connectorType: 'CRM',
    placeholder: 'pat-…',
    doc: 'https://developers.hubspot.com/',
    icon: '☰',
  },
  {
    id: 'google-workspace',
...
const DEV_CONNECTORS: KnownConnector[] = [
  ...
  },
  {
    ...
    connectorType: 'Git host',
    placeholder: 'glpat-…',
    doc: 'https://gitlab.com/-/user_settings/personal_access_tokens',
    icon: '◧',
  },
  {
    id: 'bitbucket',
    ...
    connectorType: 'Git host',
    placeholder: '…',
    doc: 'https://bitbucket.org/account/settings/app-password/',
    icon: '◈',
  },
  {
    id: 'aws',
    ...
    connectorType: 'Cloud',
    placeholder: 'AKIA…',
    doc: 'https://console.aws.amazon.com/iam',
    icon: '☁',
  },
  ...
  },
  {
    ...
    label: 'Vercel',
    category: 'dev',
    connectorType: 'Deploy',
    placeholder: '…',
    doc: 'https://vercel.com/account/tokens',
    icon: '▲',
  },
  {
    id: 'render',
    ...
    connectorType: 'Deploy',
    placeholder: 'rnd_…',
    doc: 'https://dashboard.render.com/u/settings/api-keys',
    icon: '◈',
  },
  {
    id: 'supabase',
    ...
    connectorType: 'Database',
    placeholder: 'sbp_…',
    doc: 'https://supabase.com/dashboard/account/tokens',
    icon: '⬢',
  },
  {
    id: 'docker',
    ...
    placeholder: '…',
    doc: 'https://hub.docker.com/settings/security',
    icon: '◍',
  },
  {
    id: 'stripe',
...
export const KNOWN_CONNECTORS: KnownConnector[] = [...AI_CONNECTORS, ...BUSINESS_CONNECTORS, ...DEV_CONNECTORS].sort((a, b) =>
